...
const Timeline = () => {
  ...
  return (
    <Section id='contact'>
      ...
      <SectionText>
      Embark on a journey through my remarkable achievements, 
      showcased in a chronological timeline, capturing the milestones and 
      accomplishments that have shaped my career as a full-stack developer.
      </SectionText>
