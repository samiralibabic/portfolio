...
export const technologies = {
  frontEnd: {
    markup: ["HTML", "CSS", "SCSS", "Tailwind CSS"],
    ui: ["Material UI", "Ant Design"],
    languages: ["JavaScript", "TypeScript"],
    frameworks: ["React", "React Native", "Redux", "Next.js", "Astro", "Vue.js", "Web Components"],
    tools: ["jQuery", "Vite", "Handlebars", "Electron", "Flutter", "Axios"],
    visualization: ["D3", "Highcharts"]
  },
  backEnd: {
    runtimes: ["Node.js", "Bun", "Express"],
    languages: ["JavaScript", "TypeScript", "Java", "Kotlin"],
    databases: ["MySQL", "PostgreSQL", "MongoDB", "Elasticsearch"],
    orm: ["Hibernate", "Prisma", "Supabase"],
    apis: ["GraphQL", "RESTful API", "OAuth 2.0", "Microservices"],
    infrastructure: ["Docker Compose"]
  },
  devOps: {
    cloud: ["Google Cloud", "DigitalOcean", "Vercel", "AWS", "fly.io"],
    containerization: ["Docker", "Kubernetes (k8s)"],
    buildTools: ["npm", "Maven", "Webpack"],
    ci: ["Jenkins", "TeamCity", "CI/CD"],
    versionControl: ["Git", "GitHub", "Bitbucket"]
  },
  additionalSkills: {
    methodologies: ["Test-Driven Development (TDD)", "Agile Methodologies (Scrum)", "Agile", "SOLID", "DRY", "Composable architecture"],
    security: ["Okta", "JWT"],
    cms: ["WordPress"],
    payments: ["Stripe"],
...
export const TimeLineData = [
  ...
  { year: 2025, text: 'Expanding portfolio of online businesses across e-commerce, SaaS, directories, and digital assets', },
];
