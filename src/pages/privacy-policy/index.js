    ...
    <>
      ...
      <Layout>
        ...
        <StaticPageWrapper style={{ flexDirection: 'column' }}>
          ...
          <LegalSectionText>5. Newsletter</LegalSectionText>
          <SectionSubText>Wenn Sie den auf der Website angebotenen Newsletter beziehen möchten, benötigen wir von Ihnen eine E-Mail-Adresse sowie Informationen, welche uns die Überprüfung gestatten, dass Sie der Inhaber deran gegebenen E-Mail-Adresse sind und mit dem Empfang des Newsletters einverstanden sind. Weitere Daten werden nicht bzw. nur auf freiwilliger Basis erhoben. Diese Daten verwenden wir ausschließlich für den Versand der angeforderten Informationen und geben diese nicht an Dritte weiter.</SectionSubText>
          <SectionSubText>Die Verarbeitung der in das Newsletteranmeldeformular eingegebenen Daten erfolgt ausschließlich auf Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Die erteilte Einwilligung zur Speicherung der Daten, der E-Mail-Adresse sowie deren Nutzung zum Versand des Newsletters können Sie jederzeit widerrufen, etwa über den "Austragen"-Link im Newsletter. Die Rechtmäßigkeit der bereits erfolgten Datenverarbeitungsvorgänge bleibt vom Widerruf unberührt.</SectionSubText>
          <SectionSubText>Die von Ihnen zum Zwecke des Newsletter-Bezugs bei uns hinterlegten Daten werden von uns bis zu Ihrer Austragung aus dem Newsletter bei uns bzw. dem Newsletterdiensteanbieter gespeichert und nach der Abbestellung des Newsletters oder nach Zweckfortfall aus der Newsletterverteilerliste gelöscht. Wir behalten uns vor, E-Mail-Adressen aus unserem Newsletterverteiler nach eigenem Ermessen im Rahmen unseres berechtigten Interesses nach Art. 6 Abs. 1 lit. f DSGVO zu löschen oder zu sperren.</SectionSubText>
          <SectionSubText>Daten, die zu anderen Zwecken bei uns gespeichert wurden, bleiben hiervon unberührt.</SectionSubText>
          <SectionSubText>Nach Ihrer Austragung aus der Newsletterverteilerliste wird Ihre E-Mail-Adresse bei uns bzw. dem Newsletterdiensteanbieter ggf. in einer Blacklist gespeichert, sofern dies zur Verhinderung künftiger Mailings erforderlich ist. Die Daten aus der Blacklist werden nur für diesen Zweck verwendet und nicht mit anderen Daten zusammengeführt. Dies dient sowohl Ihrem Interesse als auch unserem Interesse an der Einhaltung der gesetzlichen Vorgaben beim Versand von Newslettern (berechtigtes Interesse im Sinne des Art. 6 Abs. 1 lit. f DSGVO). Die Speicherung in der Blacklist ist zeitlich nicht befristet. Sie können der Speicherung widersprechen, sofern Ihre Interessen unser berechtigtes Interesse überwiegen.</SectionSubText>
          <LegalSectionText>6. Plugins und Tools</LegalSectionText>
        ...
        <StaticPageWrapper style={{ flexDirection: 'column' }}>
          ...
          <LegalSectionText>5. Newsletter</LegalSectionText>
          <SectionSubText>If you would like to subscribe to the newsletter offered on the website, we require your email address as well as information that allows us to verify that you are the owner of the provided email address and that you consent to receiving the newsletter. Additional data will not be collected, or will only be collected on a voluntary basis. We exclusively use this data for the purpose of sending the requested information and do not disclose it to third parties.</SectionSubText>
          <SectionSubText>The processing of the data entered into the newsletter registration form is based exclusively on your consent (Art. 6(1)(a) GDPR). The consent granted for the storage of data, the email address, and their use for sending the newsletter can be revoked at any time, for example, via the "unsubscribe" link in the newsletter. The legality of the data processing operations already carried out remains unaffected by the revocation.</SectionSubText>
          <SectionSubText>The data you provide for the purpose of subscribing to the newsletter will be stored by us until you unsubscribe from the newsletter or the newsletter service provider, and will be deleted from the newsletter distribution list after unsubscribing or when the purpose ceases to exist. We reserve the right to delete or block email addresses from our newsletter distribution list at our own discretion within the scope of our legitimate interests pursuant to Art. 6(1)(f) GDPR.</SectionSubText>
          <SectionSubText>Data that has been stored by us for other purposes remains unaffected by this.</SectionSubText>
          <SectionSubText>After unsubscribing from the newsletter distribution list, your email address may be stored by us or the newsletter service provider in a blacklist if this is necessary to prevent future mailings. The data from the blacklist will be used exclusively for this purpose and will not be merged with other data. This serves both your interest and our interest in complying with legal requirements when sending newsletters (legitimate interest within the meaning of Art. 6(1)(f) GDPR). The storage in the blacklist is not time-limited. You can object to the storage if your interests outweigh our legitimate interest.</SectionSubText>
          <LegalSectionText>6. Plugins and Tools</LegalSectionText>
